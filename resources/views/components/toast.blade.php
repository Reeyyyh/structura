@if (session('message'))
    ...
    <div id="success-toast"
        class="fixed top-5 right-5 z-[100] flex items-center justify-between bg-white border border-gray-200 {{ $textColor }} text-sm md:text-base rounded-[8px] px-4 py-3 shadow-lg min-h-[50px] w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl animate-slide-in-right transition-all duration-300">
